...
web = "https://www.flipkart.com/books/economics-business-and-management-books/pr?sid=bks,xjk&otracker=categorytree"
...
for i in range (509):
  ...
  review = driver.find_elements(By.XPATH,"(//div[@class='XQDdHH'])")
  for r in review:
...
df.to_csv (r"C:\Users\Administrator\OneDrive\Documents\Books\Economics & Business Book.csv",index= False)