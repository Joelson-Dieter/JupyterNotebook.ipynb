...
input_element.send_keys("Cycling"+Keys.ENTER)
time.sleep(2)
titles=[]
colors=[]
stars=[]
...
new_prices+=[np.nan]*(max_len-len(new_prices))
...
print(df)
df.to_csv(r"C:\Users\Administrator\OneDrive\Documents\Books\Cycling.csv",index=False)